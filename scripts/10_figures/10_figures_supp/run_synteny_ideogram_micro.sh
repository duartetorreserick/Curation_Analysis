#!/bin/bash
# =============================================================================
# run_synteny_ideogram_micro.sh
#
# Generates the Supplementary Microchromosome Synteny Ideogram comparing T2T
# with HiFi Single, HiFi Dual, and ONT Dual assemblies in butterfly layout.
#
# Output:
#   results/figures/10_figures_supp/bTaeGut7_synteny_ideogram_micro_<TIMESTAMP>.png
#   results/figures/10_figures_supp/bTaeGut7_synteny_ideogram_micro_<TIMESTAMP>.pdf
# =============================================================================
...
SCRIPT="${BASE}/scripts/10_figures/10_figures_supp/plot_synteny_ideogram_micro.py"
OUT_DIR="${BASE}/results/figures/10_figures_supp"

mkdir -p "$OUT_DIR"

TIMESTAMP="${1:-$(date +%Y%m%d_%H%M%S)}"
OUT_PNG="${OUT_DIR}/bTaeGut7_synteny_ideogram_micro_${TIMESTAMP}.png"
OUT_PDF="${OUT_DIR}/bTaeGut7_synteny_ideogram_micro_${TIMESTAMP}.pdf"

echo "=== Running Microchromosome Synteny Ideogram ==="
